import { applicationOperator, pikaOperator, serviceOperator } from '@/operators';
import { IPikaState } from './models';
import { ActionContext } from 'vuex';
import { IRootState } from '../common/models';
import { IApplication, ICredential, IPikaConfig, IPikaTask, IService, IApplicationType } from '@/models';
...
export const getApplications = async ({
  ...
  state,
  rootState
}: ActionContext<IPikaState, IRootState>): Promise<IApplication[]> => {
  console.debug('start to get applications for pika');
...
export const getService = async ({ commit, state }: ActionContext<IPikaState, IRootState>): Promise<IService> => {
  return new Promise((resolve, reject) => {
    console.debug('start to get service for pika');
