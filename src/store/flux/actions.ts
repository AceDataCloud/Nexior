...
export const getApplications = async ({
  ...
  state,
  rootState
}: ActionContext<IFluxState, IRootState>): Promise<IApplication[]> => {
...
export const getService = async ({ commit, state }: ActionContext<IFluxState, IRootState>): Promise<IService> => {
  return new Promise((resolve, reject) => {
