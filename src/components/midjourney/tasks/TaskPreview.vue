  ...
  data(): IData {
    return {
      ...
      descriptionMapping: {
        ...
        [MidjourneyImagineAction.UPSCALE4_2x]: this.$t('midjourney.description.upscale_2x'),
        [MidjourneyImagineAction.UPSAMPLE_4X]: this.$t('midjourney.description.upscale_4x'),
