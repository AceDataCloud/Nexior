...
export const QRART_DEFAULT_POSITION = 'center';
export const QRART_DEFAULT_PIXEL_STYLE = 'square';
export const QRART_DEFAULT_MARKER_SHAPE = 'square';
export const QRART_DEFAULT_SUB_MARKER = 'square';
export const QRART_DEFAULT_ROTATE = 0;
export const QRART_DEFAULT_ECL = 'H';
export const QRART_DEFAULT_PADDING_NOISE = 0;
