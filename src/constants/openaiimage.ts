...
export const OPENAIIMAGE_MODEL_GPT_IMAGE_25_FLARE_OFFICIAL = 'gpt-image-2.5-flare:official';
export const OPENAIIMAGE_MODEL_GPT_IMAGE_25_SUNBURST = 'gpt-image-2.5-sunburst';
export const OPENAIIMAGE_MODEL_GPT_IMAGE_25_SUNBURST_OFFICIAL = 'gpt-image-2.5-sunburst:official';
export const OPENAIIMAGE_MODEL_GPT_IMAGE_2_OFFICIAL = 'gpt-image-2:official';

export const OPENAIIMAGE_OFFICIAL_MODELS: string[] = [
...
export const isOpenAIImageOfficialModel = (model?: string): boolean =>
  !!model && OPENAIIMAGE_OFFICIAL_MODELS.includes(model);
...
export const OPENAIIMAGE_MODEL_SIZES: Record<string, string[]> = {
  ...
  [OPENAIIMAGE_MODEL_GPT_IMAGE_25_FLARE_OFFICIAL]: OPENAIIMAGE_SIZES_GPT_IMAGE_2,
  [OPENAIIMAGE_MODEL_GPT_IMAGE_25_SUNBURST]: OPENAIIMAGE_SIZES_GPT_IMAGE_2,
  [OPENAIIMAGE_MODEL_GPT_IMAGE_25_SUNBURST_OFFICIAL]: OPENAIIMAGE_SIZES_GPT_IMAGE_2,
